function test(){
	...
	document.getElementById("value1").innerHTML="ok";
	}
	else{
...
function test2(){
	...
	document.getElementById("value2").innerHTML="ok";
	}
	else{
...
function test3(){
	...
	document.getElementById("value3").innerHTML="ok";	
}
	else{
...
document.getElementById("value4").style.color="green";
	document.getElementById("value4").innerHTML="ok"; 
}  
else  
{  
...
function test5(){
	...
	document.getElementById("value5").innerHTML="ok";	
}
}
function test6(){
	...
	document.getElementById("value6").innerHTML="ok";	
}
	else{
